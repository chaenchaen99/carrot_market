...
part of 'w_floating_danggeun_button.state.dart';
...
mixin _$FloatingButtonState {
  ...
  bool get isBig => throw _privateConstructorUsedError;
...
abstract class $FloatingButtonStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isExpanded, bool isBig});
}
...
class _$FloatingButtonStateCopyWithImpl<$Res, $Val extends FloatingButtonState>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      isBig: null == isBig
          ? _value.isBig
          : isBig // ignore: cast_nullable_to_non_nullable
              as bool,
    ) as $Val);
  }
}
...
class _$FloatingButtonStateImpl implements _FloatingButtonState {
  const _$FloatingButtonStateImpl(this.isExpanded, this.isBig);
  ...
  @override
  String toString() {
    return 'FloatingButtonState(isExpanded: $isExpanded, isBig: $isBig)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.isBig, isBig) || other.isBig == isBig));
  }

  @override
  int get hashCode => Object.hash(runtimeType, isExpanded, isBig);
...
abstract class _FloatingButtonState implements FloatingButtonState {
  const factory _FloatingButtonState(final bool isExpanded, final bool isBig) =
