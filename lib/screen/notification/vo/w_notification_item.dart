...
import '../../../common/widget/widget_constants.dart';

class NotificationItemWidget extends ConsumerStatefulWidget {
  final DanggeunNotification notification;
          ...
          children: [
            Row(
              children: [
                ...
                width10,
                Expanded(
                  child: widget.notification.title.text.size(12).bold.make(),
                ),
                if (isEditMode)
                  IconButton(
                    onPressed: () {
